...
function App() {
  return (
    ...
    <section id="call-to-action" className="call-to-action pt-125 pb-130 bg_cover" style={{backgroundImage: 'url(/images/call-to-action.jpg)'}}>
        <div className="container">
            <div className="row justify-content-center">
                    ...
                    <div className="single-work text-center mt-30">
                        ...
                        <div className="work-overlay">
                            <div className="work-content">
                                ...
                                <ul>
                                    <li><a className="image-popup" href="/images/work/w-1.jpg"><i className="lni-plus"></i></a></li>
                    ...
                    <div className="single-work text-center mt-30">
                        ...
                        <div className="work-overlay">
                            <div className="work-content">
                                <h3 className="work-title">Product Design</h3>
                                <ul>
                                    <li><a className="image-popup" href="/images/work/w-2.jpg"><i className="lni-plus"></i></a></li>
                                    <li><a href="#"><i className="lni-link"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div className="single-work text-center mt-30">
                        ...
                        <div className="work-overlay">
                            <div className="work-content">
                                <h3 className="work-title">Product Design</h3>
                                <ul>
                                    <li><a className="image-popup" href="/images/work/w-3.jpg"><i className="lni-plus"></i></a></li>
                                    <li><a href="#"><i className="lni-link"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div className="single-work text-center mt-30">
                        ...
                        <div className="work-overlay">
                            <div className="work-content">
                                <h3 className="work-title">Product Design</h3>
                                <ul>
                                    <li><a className="image-popup" href="/images/work/w-4.jpg"><i className="lni-plus"></i></a></li>
                                    <li><a href="#"><i className="lni-link"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div className="single-work text-center mt-30">
                        ...
                        <div className="work-overlay">
                            <div className="work-content">
                                <h3 className="work-title">Product Design</h3>
                                <ul>
                                    <li><a className="image-popup" href="/images/work/w-5.jpg"><i className="lni-plus"></i></a></li>
                                    <li><a href="#"><i className="lni-link"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div className="single-work text-center mt-30">
                        ...
                        <div className="work-overlay">
                            <div className="work-content">
                                <h3 className="work-title">Product Design</h3>
                                <ul>
                                    <li><a className="image-popup" href="/images/work/w-6.jpg"><i className="lni-plus"></i></a></li>
                                    <li><a href="#"><i className="lni-link"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div className="single-pricing text-center mt-30">
                        ...
                        <div className="pricing-body">
                            ...
                            <div className="pricing-btn">
                                <a className="main-btn" href="#contact">get quote</a>
                            </div>
                        </div>
                    </div> {/* <!--  single pricing --> */}
                </div>
